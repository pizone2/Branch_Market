            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <div class="background-page">
                        <div class="banner-text"><h2>회원가입</h2></div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="checkout spad">
    <div class="container">
        ...
        <div class="checkout__form">
            <div class="row">
            <h4 class="join__title mx-auto">회원가입</h4>
            </div>
            <h3>&nbsp;</h3>
            <form action="./add" method="post" id="addForm">
                <div class="row" id="check_row">                       
                    <div class="col-lg-7 col-md-6 mx-auto">                           
                        ...
                        <div class="checkout__input">
                            <!-- <p>PW<span>*</span></p> -->
                            <input type="password" name="memberPw" id="memberPw" placeholder="PW   (10 ~ 20 자리로 입력 해주세요)" class="checkout__input__add">                                
                        </div>
                        <div id="pwMsg"></div>
                        <div class="checkout__input">
                            <!-- <p>PW CHECK<span>*</span></p> -->
                            <input type="password" id="checkMemberPw" class="checkout__input__add" placeholder="PW CHECK">                                
                        </div>        
   ...
   <!--  <form action="./add" method="post" id="addForm">
        ...
        <input type="button" value="회원가입" id="submit1">
    </form> -->
